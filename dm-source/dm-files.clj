;list of common lisp files
;loaded by the clj system 

["package-dm.lsp"
 {:directory "lib-core"
  :files ["scoreobjects.lsp" "basicmacros.lsp" "infixmath.lsp" "musicio.lsp" "rulemacros.lsp" "parallelrulemacros.lsp"
 ...
 "init.lsp"
 {:director "rules"
  :files ["frules1.lsp" "frules2.lsp" "Intonation.lsp"
